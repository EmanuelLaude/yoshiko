...
public:
    GMLOutput(ClusterEditingInstance& inst, ClusterEditingSolutions& solutions, string filename, string suffix, string label) : ClusterEditingOutput(inst, solutions, filename, suffix, label) {
    }
