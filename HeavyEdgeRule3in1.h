...
public:
    HeavyEdgeRule3in1(WorkingCopyInstance& inst, bool conserveMultipleSolutions) : FPTReductionRule(inst, "Heavy Edge Rule 3 in 1", conserveMultipleSolutions), _r1(inst.getGraph()), _r2(inst.getGraph()), _r3(inst.getGraph(), -numeric_limits<double>::infinity()) {
    }
...
private:
    ...
    list<WorkingCopyGraph::Edge> _forbidden;
    list<WorkingCopyGraph::Edge> _permanent;
};
